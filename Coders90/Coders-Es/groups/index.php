		      ...
		      buttons: {
			    Crear: function() {
			    	...
			    	if ($("#groupName").val()!="") {
			    		...
			    		$("#groupName").attr("placeholder", "Escriba el nombre");
				...
				<div id="content" class="col-lg-12">
						...
						<div class="col-sm-12">
							<div class="page-header">
								...
								<div class="clearfix">
									...
									<span><button class="btn btn-info btn-group pull-right" id="newGroup">Crear Grupo</button></span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xs-12 col-md-12">
							<div class="box">
						    	<div class="box-title small">
									<h4><i class="fa fa-search"></i>Búsqueda de grupos</h4>
								</div>
							</div>
						...
						<div class="col-xs-12 col-md-6">
							<div class="box">
						    	<div class="box-title small">
									<h4><i class="fa fa-group"></i>Grupos que he creado</h4>
								</div>
							</div>
							<?php 
								require("../SQLFunc.php");
						...
						<div class="col-xs-12 col-md-6">
							<div class="box">
						    	<div class="box-title small">
									<h4><i class="fa fa-user"></i><i class="fa fa-arrow-right"></i><i class="fa fa-group"></i>Grupos a los que pertenezco</h4>
								</div>
							</div>
							<?php 
								myGroups();
					...
					<div id="new-dialog" title="Nuevo Grupo">
					  <form>
					    <fieldset class="ui-helper-reset">
					      ...
					      <label for="groupContent">Lenguaje de programación:</label>
					      ...
					      <label for="groupColor">Selecciona un estilo:</label>
