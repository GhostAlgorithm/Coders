...
<section id="page">
			...
			<div id="sidebar" class="sidebar sidebar-fixed">
				<div class="sidebar-menu nav-collapse">
					...
					<div id="search-bar">
						<input type="text" id="searchbar" class="search" placeholder="Nombre - Apellido - Email" autocomplete="off"><i class="fa fa-search search-icon"></i>
					</div>
			...
			<div class="row">
				<div id="content" class="col-lg-12">
					...
					<div class="row">
						...
						<h4 class="miembro-desde">Miembro desde: Abril 2014</h4>
						<br>
						<br>
					...
					<div class="box">
				    	<div class="box-title small">
							<h4><i class="fa fa-edit"></i>Publicaciones</h4>
						</div>
					</div>
                    <?php 
                        myFeed($user);
