...
<section id="page">
	...
	<div id="sidebar" class="sidebar sidebar-fixed">
		<div class="sidebar-menu nav-collapse">
			...
			<div id="search-bar">
				<input type="text" id="searchbar" class="search" autocomplete="off" placeholder="Nombre - Apellido - Email"s><i class="fa fa-search search-icon"></i>
			</div>
				...
				<div id="content" class="col-lg-12">
					...
					<div class="row">
						<div class="col-xs-12 col-md-11">
							<div class="box">
						    	<div class="box-title small">
									<h4><i class="fa fa-search"></i>Búsqueda por Usuario</h4>
								</div>
							</div>
							<div class="input-group search-admin">
								<span class="input-group-addon"><i class="fa fa-search"></i></span>
								<input type="text" id="searchbar-admin" class="form-control" autocomplete="off" placeholder="Nombre - Apellido - Email"/>
							</div>
						...
						<div class="col-xs-12 col-md-12">
							<div class="box">
						    	<div class="box-title small">
									<h4><i class="fa fa-user"></i>Grupos por Usuario</h4>
								</div>
							</div>
								...
								<div class="box border orange">
									...
									<div class="box-body">
										<table class="table" class="users">
											<thead>
												<tr>
													<th><h4><strong>Foto</strong></h4></th>
													<th><h4><strong>ID</strong></h4></th>
													<th><h4><strong>Nombre</strong></h4></th>
													<th><h4><strong>Email</strong></h4></th>
													<th class="actions"><strong><h4>Acciones</strong></h4></th>
												</tr>
											</thead>
											<tbody>
												<?php 
