								...
								<form method="POST" action="actions.php?user=<?php echo $_GET['user'];?>">
									<div class="col-xs-12 col-md-12">
										<div class="col-xs-6 col-md-3">
											<input type='checkbox' id='selPost' name="selPost" class="pull-left"><label for="selPost" class="labelMargin">Seleccionar todos</label>
										</div>
										<div class="col-xs-6 col-md-9">
											<input type='submit' name="showPost" class="btn btn-success btn-xs pull-right btnSpace" value="Mostrar">
											<input type='submit' name="delPost" class="btn btn-danger btn-xs pull-right btnSpace" value="Eliminar">
										</div>
									</div>
