...
<?php
	...
	while ($row=mysql_fetch_array($result)) {
		...
		if ($row[5]=="1") {
			$state="Visible";
			$editForm="<input type='submit' name='visiblePost' class='btn btn-danger btn-xs pull-right btnSpace' value='Eliminar Post'>";
		} else {
			$state="No visible (Eliminado)";
			$editForm="<input type='submit' name='noVisiblePost' class='btn btn-success btn-xs pull-right btnSpace' value='Habilitar Post'>";
		}
	...
	if ($totalComments!=0) {
		...
		<form method='POST' action='postActions.php?postIdf=".$_GET['postIdf']."'>
			<div class='col-xs-12 col-md-4'>
					<input type='submit' name='showComments' class='btn btn-success btn-xs pull-right btnSpace' value='Mostrar Comentarios'>
					<input type='submit' name='delComments' class='btn btn-danger btn-xs pull-right btnSpace' value='Eliminar Comentarios'>
			</div>
		...
		<form method='POST' action='postActions.php?postIdf=".$_GET['postIdf']."'>
			<div class='col-xs-12 col-md-4'>
					<input type='submit' name='showComments' class='btn btn-success btn-xs pull-right btnSpace' value='Mostrar Comentarios' disabled>
					<input type='submit' name='delComments' class='btn btn-danger btn-xs pull-right btnSpace' value='Eliminar Comentarios' disabled>
			</div>
			<div class='col-xs-12 col-md-12' >
				<div class='divide-20'></div>
				<div class='box-body clearfix adjust-text' style='word-wrap:break-word;z-index:2; position: relative;'>
				...
				<div id="content" class="col-lg-12">
						...
						<div class="col-sm-12">
							<div class="page-header">
								...
								<ul class="breadcrumb">
									...
									<li>
										<a href="../post/actions.php?user=<?php echo $userId;?>">Posts de <?php echo $fn." ".$ln;?></a>
									</li>
									<li>
										<a href="#">Detalles</a>
									</li>
					...
					<div class="row">
						<div class="col-xs-12 col-md-12">
							...
							if(isset($_GET["chg"])){
								if ($_GET["chg"]==1) {
									echo"<div class='alert alert-success col-xs-12 col-md-12'>Datos actualizados satisfactoriamente</div>";
								} else {
						...
						<div class="col-xs-12 col-md-12" >
							<div class="col-xs-12 col-md-2" >
								<strong><h5>Creador:</h5></strong>
							</div>
							<div class="col-xs-12 col-md-10">
								<h5><?php echo "  ".$fn." ".$ln." (".$userId.")"?></h5>
							</div>
							<div class="col-xs-12 col-md-2" >
								<strong><h5>Fecha y Hora:</h5></strong>
							</div>
							<div class="col-xs-12 col-md-10">
