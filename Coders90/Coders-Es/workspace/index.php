							...
							<div id="newsFeed">
								...
								if(isset($_GET['chg'])){
									if ($_GET['chg']==1) {
										...
										echo"<div class='alert alert-warning col-xs-12 col-md-12'>Existe un archivo con el mismo nombre</div>";
									} else {
										echo"<div class='alert alert-danger col-xs-12 col-md-12'>Error al subir el archivo, inténtelo de nuevo :( </div>";
									}
								}
								?>
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Mis Archivos</h4>
									</div>
													  ...
													  if ($file != '.' && $file != '..') { 
													  	...
													  	if ($resultadoHtml==true || $resultadoHtm==true) {
													  		echo "<div class='col-md-3 col-xs-6 idfHtml'>
																	<div>
													  					<h5><span>".$file."</span>
													  					<a><span class='pull-right btnSpace'><i class='fa fa-fw fa-times' id='".$file."' onClick='delFile(this)' title='Eliminar Archivo'></i>	</span>
													  					<a href='".$dir.$file."' download='".$file."'>
													  					<span class='pull-right'><i class='fa fa-fw fa-cloud-download' title='Descargar Archivo'></i></span></a>
													  					<a href='../editor/?id=".$file."&type=html'><span class='pull-right'><i class='fa fa-edit btnSpace' title='Editar Archivo'></i></a></span></h5>
													  				</div>
													  		...
													  		echo "<div class='col-md-3 col-xs-6 idfJs'>
																	<div>
													  					...
													  					<a href='".$dir.$file."' download='".$file."'>
													  					<span class='pull-right'><i class='fa fa-fw fa-cloud-download' title='Descargar Archivo'></i></span></a>
													  					<a href='../editor/?id=".$file."&type=javascript'><span class='pull-right'><i class='fa fa-edit btnSpace' title='Editar Archivo'></i></a></span></h5>
													  				</div>
																	<div class='filter-content'>
																		<div class='img-text'><span>{ ".$file." }</span></div>
													  		...
													  		echo "<div class='col-md-3 col-xs-6 idfCss'>
																	<div>
													  					...
													  					<a href='".$dir.$file."' download='".$file."'>
													  					<span class='pull-right'><i class='fa fa-fw fa-cloud-download' title='Descargar Archivo'></i></span></a>
													  					<a href='../editor/?id=".$file."&type=css'><span class='pull-right'><i class='fa fa-edit btnSpace' title='Editar Archivo'></i></a></span></h5>
													  				</div>
																	<div class='filter-content'>
																		<div class='img-text'><span>{ ".$file." }</span></div>
													  		...
													  		echo "<div class='col-md-3 col-xs-6 idfPhp'>
													  				<div>
													  					...
													  					<span class='pull-right'><i class='fa fa-fw fa-cloud-download' title='Descargar Archivo'></i></span></a>
													  					<a href='../editor/?id=".$file."&type=php'><span class='pull-right'><i class='fa fa-edit btnSpace' title='Editar Archivo'></i></a></span></h5>
													  				</div>
																	<div class='filter-content'>
