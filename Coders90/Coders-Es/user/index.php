				...
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							...
							if(isset($_GET["up"])){
								if ($_GET["up"]==0) {
									echo"<div class='alert alert-danger col-xs-12 col-md-12'>Ha ocurrido un error, Intentelo de Nuevo :( </div>";
								} else {
									echo"<div class='alert alert-success col-xs-12 col-md-12'>Subida Completa</div>";
								}
							...
							if($edit==1){
								...
								echo"<div class='alert alert-success col-xs-12 col-md-12'>Cambios Guardados Exitosamente</div>";
							}?>
							    <div class="box">
									...
									<div class="box-body">
										<form name="UpPic" id="UpPic" method="post" action="UR.php" enctype="multipart/form-data">
											...
											<div class="col-xs-12 col-md-9">
												...
												<div class="col-xs-12 col-md-12 ">
													<center><input name="btnUpload" id="btnUpload" type="submit" class="btn btn-primary col-xs-12 col-md-3" value="Subir"/></center></br>
												</div>
											</div>
										</form>
									</div>
									...
									<div class="box-body" style="word-wrap: break-word;">
										<form method="post" action="../user/" name="EditData">
											...
											<div class="col-xs-12 col-md-6 form-group">
												...
												<input type="text" class="form-control" name="FirstName" placeholder="Nombre" onkeypress="valText()" value="<?php echo $fn;?>" required/>
											</div>
											<div class="col-xs-12 col-md-6 form-group">
												<label for="LastName">Apellido:</label>
												<input type="text" class="form-control" name="LastName" placeholder="Apellido" onkeypress="valText()" value="<?php echo $ln;?>"required/>
											</div>
