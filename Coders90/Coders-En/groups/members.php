					...
					<div class="row">
						...
						<div class="box">
					    	<div class="box-title small">
								<h4><i class="fa fa-user"></i><i class="fa fa-arrow-right"></i><i class="fa fa-group"></i>Add members</h4>
							</div>
						</div>
						<div class="col-xs-12 col-md-12">
							<div class="input-group search-admin col-xs-12 col-md-9 pull-left">
								<span class="input-group-addon"><i class="fa fa-search"></i></span>
								<input type="text" id="searchbar-members" class="form-control" autocomplete="off" placeholder="Name - Last Name - Email"/>
							</div>
							<div class="divide-15 visible-xs"></div>
							<div class="col-xs-12 col-md-2 pull-right">
								<button class="btn btn-primary disabled=" id="addMembers" disabled>Add</button>
							</div>
						</div>
								...
								if ($idCreator==$_SESSION['UserID']) {
									if($row[0]==$_SESSION['UserID']){
										echo "<div class='col-md-3 col-xs-6 col-lg-2 user-container'>
											...
											<h5>".$row[1]." ".$row[2]."</h5></a>
											<button class='btn btn-xs btn-info disabled' id='btnEliminar'>You (Administrator)</button>
										</div>";
 									} else {
 										echo "<div class='col-md-3 col-xs-6 col-lg-2 user-container'>
											<a href='../profile/?user=".$row[0]."' class='styleLess'><img class='member-img' alt='' src='../img/avatars/".$row[0].".jpg' onerror=\"this.src='../img/avatars/default.jpg'\"/>
											<h5>".$row[1]." ".$row[2]."</h5></a>
											<button class='btn btn-xs btn-info' id='btnEliminar' u='".$row[0]."' onClick='delUser(this)'>Delete</button>
										</div>";
 									}
								} else {
									if($row[0]==$idCreator){
										echo "<div class='col-md-3 col-xs-6 col-lg-2 user-container'>
											<a href='../profile/?user=".$row[0]."' class='styleLess'><img class='member-img' alt='' src='../img/avatars/".$row[0].".jpg' onerror=\"this.src='../img/avatars/default.jpg'\"/>
											<h5>".$row[1]." ".$row[2]."</h5>
											<button class='btn btn-xs btn-info disabled'>Administrator</button></a>
										</div>";
									} else {
										if ($row[0]==$_SESSION['UserID']) {
											echo "<div class='col-md-3 col-xs-6 col-lg-2 user-container'>
												...
												<h5>".$row[1]." ".$row[2]."</h5>
												<button class='btn btn-xs btn-info'>You</button></a>
											</div>";
										} else {
											echo "<div class='col-md-3 col-xs-6 col-lg-2 user-container'>
												<a href='../profile/?user=".$row[0]."' class='styleLess'><img class='member-img' alt='' src='../img/avatars/".$row[0].".jpg' onerror=\"this.src='../img/avatars/default.jpg'\"/>
												<h5>".$row[1]." ".$row[2]."</h5>
												<button class='btn btn-xs btn-info'>View Profile</button></a>
											</div>";
										}
									}
								}
...
<div id="dialog-confirm-user" title="Coders" style="display:none">
  <p><h3><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></h3></span>Are you sure you want to remove this user from <?php echo $gName;?>?</p>
</div>
<!-- Core Bootstrap-->
<!--/PAGE -->
<!-- JAVASCRIPTS -->
