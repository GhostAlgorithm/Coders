...
<?php
	...
	if(isset($_POST["btnPost"])){
		...
		//Notifications de publicaciones en grupos
				...
				<div id="content" class="col-lg-12">
								...
								<div class="clearfix">
									...
									<?php 
										if (partOf($_GET['group'])) {
											echo "<span><button class='compose tip btn btn-danger btn-group spacer-7 pull-right' data-original-title='Leave groups' user='".$_SESSION['UserID']."' group='".$_GET['group']."' id='leaveGroup'><i class='fa fa-sign-out'></i></button></span>
												  <span><a href='settings.php?group=".$_GET['group']."'><button class='compose tip btn btn-primary  btn-group spacer-7 pull-right' data-original-title='Settings' id='htmlBtn'><i class='fa fa-cog'></i></button></a></span>
												  ...
												  <span><a href='members.php?group=".$_GET['group']."'><button class='compose tip btn btn-success  btn-group spacer-7 pull-right' data-original-title='Members' id='jsBtn'><i class='fa fa-users'></i></button></a></span>";
										} else {
											echo "<span><button class='compose tip btn btn-success btn-group pull-right' data-original-title='Join Group' user='".$_SESSION['UserID']."' group='".$_GET['group']."' id='joinGroup'><i class='fa fa-plus'></i> <i class='fa fa-user'></i></button></span>";
										}
									?>
									</div>
								</div>
					...
					<div class="row">
						<div class="col-xs-12 col-md-12 pull-right">
							...
							<?php 
								if (partOf($_GET['group'])) {
									echo "<center><a href='members.php?group=".$_GET['group']."'><button class='btn btn-success col-xs-5 pull-left' id='jsBtn'><i class='fa fa-users'></i> Members</button></a>
										  ...
										  <a href='settings.php?group=".$_GET['group']."'><button class='btn btn-primary col-xs-5 pull-left' id='htmlBtn'><i class='fa fa-cog'></i> Settings</button></a>
										  <button class='btn btn-danger col-xs-5  pull-right' user='".$_SESSION['UserID']."' group='".$_GET['group']."' id='leaveGroup'><i class='fa fa-sign-out'></i> Leave Group</button><center></center>";
								} else {
									echo "<button class=btn btn-success pull-right' user='".$_SESSION['UserID']."' group='".$_GET['group']."' id='joinGroup'><i class='fa fa-plus'></i> Join Group<i class='fa fa-user'></i></button>";
								}
							?>
							<div class="divide-25"></div>
							</div>
