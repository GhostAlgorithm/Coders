				    	...
				    	<div class='box-title small'>
							...
							<div class='pull-right'>
								<span class='timeclass pull-right'>
									...
									<span>&nbsp;&nbsp;<span class='compose tip-left' title='Delete Post'><i class='fa fa-times-circle delete-comment timeclass' title='Delete Post' idf='".$row[0]."' post-idf='".$row[7]."' onClick='delPost(this)'></i></span></span>
								</span>
							</div>
						</div>	
			...
			$comment.="<div class='box-body clearfix adjust-text' style='word-wrap:break-word;'>
						<span>
							...
							<div class='col-xs-10 col-md-11'>
								<div class='col-xs-12 col-md-12'>
									<textarea style='padding: 1em;' class='comment-area ".$_GET['i']."' placeholder='Write a comment...'></textarea>
