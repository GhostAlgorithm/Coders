...
<section id="page">
	...
	<div id="sidebar" class="sidebar sidebar-fixed">
		<div class="sidebar-menu nav-collapse">
			...
			<div id="search-bar">
				<input type="text" id="searchbar" class="search" autocomplete="off" placeholder="Name - Last Name - Email"s><i class="fa fa-search search-icon"></i>
			</div>
				...
				<div id="content" class="col-lg-12">
					...
					<div class="row">
						<div class="col-xs-12 col-md-11">
							<div class="box">
						    	<div class="box-title small">
									<h4><i class="fa fa-search"></i>Search by users</h4>
								</div>
							</div>
						...
						<div class="col-xs-12 col-md-12">
							<div class="box">
						    	<div class="box-title small">
									<h4><i class="fa fa-user"></i>Posts by users</h4>
								</div>
							</div>
