				...
				<div id="content" class="col-lg-12">
						...
						<div class="col-sm-12">
							<div class="page-header">
								...
								<ul class="breadcrumb">
									...
									<li>
										<a href="../groups/actions.php?user=<?php echo $gCreator;?>">Groups created by <?php echo $uName." ".$uLast;?></a>
									</li>
									<li>
										<a href="#">Details</a>
									</li>
					...
					<div class="row">
						<div class="col-xs-12 col-md-12">
							...
							<div class="box">
						    	<div class="box-title small">
									<h4><i class="fa fa-bars"></i>Details</h4>
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-6" >
							...
							<div class="col-xs-12 col-md-12" >
								<button class="btn btn-danger btn-xs ">Delete Group</button>
							</div>
						</div>
						<div class="col-xs-12 col-md-6" >
							<div class="col-xs-12 col-md-12" >
							...
							<div class="divide-15"></div>
							<div class="col-xs-12 col-md-12" >
								<a href="../users/actions.php?user=<?php echo $gCreator;?>"><button class="btn btn-info btn-xs ">Update Information</button></a>
							</div>
						</div>
							...
							<form action="groupsActions.php?groupIdf=<?php echo $_GET['groupIdf']?>" method="POST">
								<div class="col-md-12 col-xs-12">
									<div class="col-xs-6 col-md-3">
										<input type='checkbox' id='selMembers' name="selMembers" class="pull-left"><label for="selMembers" class="labelMargin">Select all</label>
									</div>
									<div class="col-xs-6 col-md-9">
										<input type='submit' name="delMembers" class="btn btn-danger btn-xs pull-right" value="Delete selected members">
									</div>
								</div>
								<?php 
								...
								while ($row=mysql_fetch_array($result)) {
									echo "<div class='col-md-3 col-xs-6 col-lg-2 user-container'>
											...
											<h5>".$row[1]." ".$row[2]."</h5></a>
											<input type='checkbox' id='".$index."' value='".$row[0]."' name='members[]'> <label for='".$index."' class='label label-info'> Select</label>
										</div>";
									$index++;								
								}
								?>
