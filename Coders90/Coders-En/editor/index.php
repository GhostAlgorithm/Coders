			  ...
			  buttons: {
			    Create: function() {
				    if (tabTitle.val()!="") {
				    	...
				    	$("#tab_title").attr("placeholder", "Type a filename");
					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-xs-12 col-md-12" >
								...
								<button id="add_tab" class="btn btn-primary">New File</button>
								<button id="saveFileBtn" class="btn btn-primary pull-right">Save File</button>
								...
								<div id="tabs">
								  <ul id="tabs-identifier">
								    <?php 
								    		if (isset($_GET['id'])) {
								    			if ($esp) {
								    				echo "<li><a id='".$_GET['id'].".php' editor='aceEditor1' href='#tabs-1' onClick='activeEditor(this)'>".$_GET['id'].".php</a> <span class='ui-icon ui-icon-close' role='presentation'>Close</span></li>";	
											} else {
								    				echo "<li><a id='".$_GET['id']."' editor='aceEditor1' href='#tabs-1' onClick='activeEditor(this)'>".$_GET['id']."</a> <span class='ui-icon ui-icon-close' role='presentation'>Close</span></li>";
								    			}
								    		} else {
								    			echo "<li><a id='Prueba.html' editor='aceEditor1' href='#tabs-1' onClick='activeEditor(this)'>Coders</a> <span class='ui-icon ui-icon-close' role='presentation'>Close</span></li>";	
								    		}
								    ?> 
								  </ul>
								  <div id="tabs-1">
...
efficiency even when you're not at home.

Instructions:

<span><</span><span>/></span> You can create your files in the programming languages mentioned bellow:
	•HTML.
	•PHP.
	•CSS.
	•JavaScript.

<span><</span><span>/></span> To create your files, simply press the 'New File' button and complete the 
    'New file' form.

<span><</span><span>/></span> To save your files just press the 'Save File' button or just press 
    «Ctrl + S» keys.

<span><</span><span>/></span> The code files created here can be downloaded from your Workspace.";
								    }
									?>
								    </div>
								  </div>
		...
		<div id="dialog-empty" title="Coders" style="display:none">
		 	<p><h3><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></h3></span>You can't save an empty file</p>
		</div>
		<div id="dialog-success" title="Coders" style="display:none">
		 	<p><span style="float:left; margin:0 7px 20px 0;"></span><br>File saved successfully</p>
		</div>
